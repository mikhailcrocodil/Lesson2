package ru.mirea.martynovmv.notificationapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickSendNotification (View view)
    {
        ...
        NotificationChannel channel = new NotificationChannel(CHANNEL_ID, "Student Мартынов М.В. Notification", importance);
